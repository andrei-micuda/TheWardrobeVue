<template>
  <div class="flex items-center space-x-5">
    ...
    <router-link
      to="/cart"
      class="flex items-center text-gray-100 hover:text-gray-200"
    >
    ...
    <div class="relative inline-block text-left">
      <button
        ...
        @click="() => $store.commit('setIsDrawerVisible', true)"
      >
      ...
      >
        <ul v-if="id">
          <li>
            <router-link to="/account" class="block py-2 text-sm"
              >My Account</router-link
            >
          </li>
          <li>
            <router-link to="/orders" class="block py-2 text-sm"
              >Orders</router-link
            >
          </li>
          <li>
        ...
        <ul v-else>
          <li>
            <router-link to="/signIn" class="block py-2 text-sm"
              >Sign in</router-link
            >
          </li>
          <li>
            <router-link to="/register" class="block py-2 text-sm"
