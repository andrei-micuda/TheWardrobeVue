<template>
  <section id="AccountDetailsSection">
    ...
    <a-form :form="form" @submit="handleSubmit" hideRequiredMark class="bg-gray-700 p-4 mb-5">
      ...
      <a-form-item label="Last Name" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
        <a-input
          v-decorator="[
            'lastName',
            {
      ...
      <a-form-item label="Email" class="mr-6" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
        <a-input
          v-decorator="[
            'email',
            {
      ...
      <a-form-item label="Phone Number" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
        <a-input
          v-decorator="[
            'phoneNumber',
          ]"
